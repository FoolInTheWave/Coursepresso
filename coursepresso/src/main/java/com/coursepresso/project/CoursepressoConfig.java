...
import com.coursepresso.project.presenter.NewCourseSectionPresenter;
...
public class CoursepressoConfig {

  public CoursepressoConfig() {
    super();
  }
  ...
  @Bean
  public NewCourseSectionPresenter newCourseSectionPresenter() {
